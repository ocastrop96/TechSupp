...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="card">
            ...
            <div class="card-body">
                <table id="datatableUsuariosSTW" class="table table-bordered table-hover dt-responsive datatableUsuariosSTW">
                    <thead>
                        <tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="" id="form-reg-usuario" role="form" method="post">
                <div class="modal-header text-center" style="background: #3c8dbc; color: white">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4" id="btnDNIUsuario">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <button type="button" class="btn btn-block btn-success" id="btnDNIU"><i class="fas fa-search"></i>&nbsp;Consulta DNI</button>
                                </div>
                            </div>
                        </div>
                        <!-- Bloque de DNI -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <select class="form-control" style="width: 100%;" id="perfilUsuario" name="perfilUsuario" required>
                                        ...
                                        $itemPerfil = null;
                                        $valorPerfil  = null;
                                        $perfil = UsuariosControlador::ctrListarTipoRoles($itemPerfil, $valorPerfil);
                ...
                <?php
                $registrarUsuario = new UsuariosControlador();
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <select class="form-control" style="width: 100%;" name="edtperfilUsuario" id="edtperfilUsuario1" required>
                                        ...
                                        $itemPerfil2 = null;
                                        $valorPerfil2  = null;
                                        $perfil2 = UsuariosControlador::ctrListarTipoRoles($itemPerfil2, $valorPerfil2);
