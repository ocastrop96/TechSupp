...
class LicenciasModelo
{
    ...
    static public function mdlRetornaCorrelativo($empleado, $autogenerado)
    {
        $stmt = Conexion::conectar()->prepare("CALL Retorna_Correlativo_Dias(:empleado,:autogenerado,@val)");
